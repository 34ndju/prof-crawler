...
with open("emery_corpus.csv", "rb") as csvin:
    ...
    header = next(csvin)
    a = [dict(zip(header, map(str, row))) for row in csvin]
...
if __name__ == '__main__':
    # cred to http://edmundmartin.com/scraping-google-with-python/ because I'm too lazy to write my own
